...
var render = function render() {
  ...
  })], 1)], 1)], 1), _vm._v(" "), _vm.payment.status != "pending" || _vm.payment.status != "credit" ? _c("b-col", {
    attrs: {
      md: "4"
    }
  }, [_c("validation-provider", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(validationContext) {
        return [_c("b-form-group", {
          ...
          attrs: {
            disabled: _vm.payment.status == "credit",
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(validationContext) {
        return [_c("b-form-group", {
          ...
          attrs: {
            disabled: _vm.payment.status == "paid" || _vm.payment.status == "credit",
            label: "Amount",
