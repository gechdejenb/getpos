                      ...
                      <b-card-body>
                        <b-row>
                          <b-col md="8" sm="12">
                            ...
                            <b-form-group :label="$t('TelegramAdminChatId')">
                              <b-form-input
                                v-model="setting.telegram_admin_chat_id"
                                readonly
                              ></b-form-input>
                            </b-form-group>
                            <small class="text-muted">
                              {{$t('TelegramAdminChatId')}}: {{ setting.telegram_admin_chat_id || '-' }}
                            </small>
                            <div v-if="telegramAuthUrl" class="mt-2">
                              <a :href="telegramAuthUrl" target="_blank" rel="noopener">
                                {{$t('OpenTelegramAuth')}}
                              </a>
                            </div>
    ...
    InitTelegramWidget() {
      ...
      axios
        ...
        .then(response => {
          ...
          if (popup && this.telegramAuthUrl) {
            popup.location = this.telegramAuthUrl;
          } else if (this.telegramAuthUrl) {
            window.open(this.telegramAuthUrl, "_blank", "noopener");
          }
        })
        .catch(() => {
